package com.fortuneboot.common.utils.file;
...
class FileUploadUtilsTest {
    ...
    void getFileAbsolutePath() {
        FortuneBootConfig fortuneBootConfig = new FortuneBootConfig();
        fortuneBootConfig.setFileBaseDir("D:\\fortuneboot");

        String fileAbsolutePath = FileUploadUtils.getFileAbsolutePath(UploadSubDir.AVATAR_PATH, "test.jpg");

        Assertions.assertEquals("D:\\fortuneboot\\profile\\avatar\\test.jpg", fileAbsolutePath);
    }
}
