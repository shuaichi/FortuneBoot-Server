...
@Service
@AllArgsConstructor
public class FortuneRecurringBillRuleRepoImpl extends ServiceImpl<FortuneRecurringBillRuleMapper, FortuneRecurringBillRuleEntity> implements FortuneRecurringBillRuleRepo {
