 ...
 **/
@Component
public class LoanRepayStrategy extends AbstractBillStrategy {


    public LoanRepayStrategy(ApplicationScopeBo applicationScopeBo) {
    ...
    public BillTypeEnum getSupportedBillType() {
        return BillTypeEnum.LOAN_REPAY;
    }
}
